...
func ImportFileExWithProperties(file string) *Scene {
	...
	return (*Scene)(C.aiImportFileExWithProperties(pFile,
		C.uint(Process_Triangulate|Process_GenSmoothNormals|Process_JoinIdenticalVertices),
		nil,
		(*C.struct_aiPropertyStore)(props)))
}
